...
<Grid gap={2} columns={[2, '1fr 1fr']}>
  <Box>
    ...
    <Link href='mailto:mail2ypd@gmail.com' variant='styles.a' sx={{fontSize: '2rem', mr: '3'}}><FontAwesomeIcon icon={faEnvelopeSquare} /></Link>
    <Link href='https://github.com/Amorpheuz/' variant='styles.a' sx={{fontSize: '2rem', mr: '3'}}><FontAwesomeIcon icon={faGithubSquare} /></Link>
    <Link href='https://www.linkedin.com/in/Amorpheuz/' variant='styles.a' sx={{fontSize: '2rem', mr: '3'}}><FontAwesomeIcon icon={faLinkedin} /></Link>
    <Link href='https://twitter.com/Amorpheuz/' variant='styles.a' sx={{fontSize: '2rem', mr: '3'}}><FontAwesomeIcon icon={faTwitterSquare} /></Link>
    <Link href='https://dev.to/amorpheuz' variant='styles.a' sx={{fontSize: '2rem'}}><FontAwesomeIcon icon={faDev} /></Link>
  </Box>
  <Box>
    <Heading variant='styles.h2' sx={{mb:0}}>favoriteTechnologies</Heading>
